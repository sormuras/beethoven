...
public class Car {
  ...
  public void setGear(Number gear) {
    this.gear =
        java.util.Objects.requireNonNull(gear, "Property `gear` requires non `null` values!");
  }
  ...
  public Car setState(Thread.State state) {
    this.state =
        java.util.Objects.requireNonNull(state, "Property `state` requires non `null` values!");
    return this;
  }
